name: raysurfer description: "Cache and reuse code from prior AI agent executions via Raysurfer. Search before coding, upload after success." argument-hint: "[search query or "upload"]" allowed-tools:
